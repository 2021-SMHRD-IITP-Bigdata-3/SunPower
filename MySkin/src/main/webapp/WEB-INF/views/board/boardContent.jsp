				...
				<ul>
                  ...
                  <path d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
					...
					<li class="relative px-6 py-3">
						<c:if	test="${sessionScope.members.mb_id == null}"> <!-- 로그인 회원가입 버튼 -->
						<div class="px-6 my-6">
							<a
			...
			<main class="h-full overflow-y-auto">
				<div class="container px-6 mx-auto grid">
					...
					<div
						...
						<label
							class="block text-sm dark:text-gray-400 text-center font-semibold" id="title">
							${to.article_title}
						</label>
					</div>
					<div
					...
					<button
						...
						onClick="location.href='${spath}/board/board_list'">뒤로</button><br>
					<button
						class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
						onClick="goDel()">삭제</button><br>
					<button
						class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
