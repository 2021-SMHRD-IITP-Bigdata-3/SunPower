...
@media (max-width: 800px) {
  ...
  <body>
        ...
        <main class="h-full overflow-y-auto">
          ...
          <c:if test="${sessionScope.members.mb_id != null}">
            <h2 class="mt-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
              ${sessionScope.members.mb_name} 님
              <br>피부에 양보하세요!<br/>
	...
	<!-- 본문 시작 -->
            ...
            <!-- 피부타입 버튼 -->
            <c:if test="${sessionScope.members.mb_id != null}">
            	<c:if test="${sessionScope.members.st_id == 0}">
            <a
				...
				<div class="list con">
				    <ul class="row">
				        ...
				        <li class="cell">
				            ...
				            <div class="product-name dark:text-gray-200 word"><a href="product_view.jsp?id=<c:out value="${product.prod_id}" />"><c:out value="${product.prod_name}" /></a></div>
