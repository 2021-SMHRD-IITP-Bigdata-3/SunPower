		...
		<div class="flex flex-col flex-1 w-full">
          ...
          %>
						<h2
							...
							타입인 <span style="color: #34D399"><%= info.getMember_name() %></span>님에게<br>
							추천하는 화장품이에요!
						</h2>
						<% } %>
					</div>
					...
					<div
						class="max-w-2xl px-2 mb-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
						<h2
							class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"
							style="margin-bottom: -10px;">추천 화장품</h2>
						<div class="list con">
							<span><br></span>
							<ul class="row">
								<%
				    	...
				    	%>
								<li class="cell">
									<div class="img-box">
										<img
											src="./assets/img/product_img/<%=product_list.get(i).getProduct_id() %>.jpg"
											alt="">
									</div>
									<div class="product-name dark:text-gray-200 word">
										<a
											href="product-view.jsp?id=<%=product_list.get(i).getProduct_id()%>"><%= product_list.get(i).getProduct_name() %></a>
									</div>
